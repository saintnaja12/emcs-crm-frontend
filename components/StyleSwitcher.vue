...
export default {
    ...
    computed: {
        ...
        vxSidebarMainAccordionMode () {
            return this.$store.getters.accordionMode;
        }
    },
    watch: {
    ...
    methods: {
        ...
        scrollToActiveToggle (state) {
            this.$store.dispatch('sidebarMainScrollToActiveToggle', state);
        },
        accordionModeToggle (state) {
            this.$store.dispatch('sidebarMainAccordionModeToggle', state);
        }
    }
}
</script>
