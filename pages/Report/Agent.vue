				...
				<ScCard>
					...
					<ScCardBody>
						...
						<div data-uk-grid="" class="uk-child-width-expand@m uk-grid-small uk-grid">
							...
							<div>
								<select v-model="form.sla" class="uk-select">
									<option v-for="option in slaOption" v-bind:value="option.value">
										{{ option.text }}
									</option>
								</select>
							</div>
...
<script>
	...
	export default {
		...
		data: () => ({
			...
			slaOption: [
				{ text: 'All SLA', value: '' },
				{ text: 'In SLA', value: 'in' },
				{ text: 'Over SLA', value: 'over' },
			],
			applicationOption: [
			...
			fields: [
				...
				{ key: 'sla', label: 'SLA (Team)', sortable: true, class: 'text-left' },
