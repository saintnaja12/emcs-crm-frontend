	...
	export default {
		...
		data: () => ({
			...
			fields: [
				...
				{ key: 'callInTime', label: 'Date Call In', sortable: true, class: 'text-left' },
				{ key: 'pickupTime', label: 'Pick up Time', sortable: true, class: 'text-left' },
				{ key: 'hangupTime', label: 'Hang up Time', sortable: true, class: 'text-left' },
				{ key: 'avgTime', label: 'AVG Time', sortable: true, class: 'text-left' },
			],
			pieChart: "",
			pieChartOption: [
				{ text: 'Agent', value: 'agent' },
				{ text: 'Customer Type', value: 'customerType' },
				{ text: 'AVG Time', value: 'avg' },
