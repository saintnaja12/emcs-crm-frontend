			...
			<div id="sc-page-top-bar" class="sc-top-bar">
				<div class="sc-top-bar-content uk-flex uk-flex-1">
					<h1 class="sc-top-bar-title uk-text-uppercase uk-flex-1">
						Satisfaction Survey (Summary All)
					</h1>
				</div>
			</div>
		</no-ssr>
	...
	export default {
		...
		data: () => ({
			...
			fieldsummary: [
				...
				{ key: 'verygood', label: 'Very Good', sortable: true, class: 'text-left' },
				{ key: 'good', label: 'Good', sortable: true, class: 'text-left' },
				{ key: 'medium', label: 'Medium', sortable: true, class: 'text-left' },
				{ key: 'poor', label: 'Poor/Improvement', sortable: true, class: 'text-left' },
				{ key: 'complain', label: 'Complain', sortable: true, class: 'text-left' },
			...
			fielddetail: [
				...
				{ key: 'customerName', label: 'Customer Name', sortable: true, sortDirection: 'desc' },
				{ key: 'surveyDate', label: 'Survey Date', sortable: true, sortDirection: 'desc' },
			],
			pieChart: "",
			pieChartOption: [
				{ text: 'Complain', value: 'complain' },
				{ text: 'Survey Result', value: 'survey' },
