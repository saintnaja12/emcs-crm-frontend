		...
		<div id="sc-page-content">
			<div class="uk-width-1-1">
				<ScCard>
					...
					<ScCardBody>
						<div data-uk-grid="" class="uk-child-width-expand@s uk-grid-small uk-grid">
						...
						<div data-uk-grid="" class="uk-child-width-expand@m uk-grid-small uk-grid">
							...
							<div>
								<select v-model="form.subject" class="uk-select">
									<option v-for="option in subjectOption" v-bind:value="option.value">
										{{ option.text }}
									</option>
								</select>
							</div>
							...
							<div>
								<select v-model="form.agent" class="uk-select">
									<option v-for="option in agentOption" v-bind:value="option.value">
										{{ option.text }}
									</option>
								</select>
							</div>
	...
	export default {
		...
		data: () => ({
			...
			fields: [
				...
				{ key: 'ticketType', label: 'Ticket Type', sortable: true, class: 'text-left' },
				...
				{ key: 'application', label: 'Application', sortable: true, class: 'text-left' },
				{ key: 'categoryIssue', label: 'Category Issue', sortable: true, class: 'text-left' },
				{ key: 'subject', label: 'Subject', sortable: true, class: 'text-left' },
				{ key: 'ticketStatus', label: 'Ticket Status', sortable: true, class: 'text-left' },
				{ key: 'openDate', label: 'Open Date', sortable: true, class: 'text-left' },
				{ key: 'closeDate', label: 'Close Date', sortable: true, class: 'text-left' },
			],
			pieChart: "",
			pieChartOption: [
				{ text: 'Hashtag 1', value: '1' },
				{ text: 'Hashtag 2', value: '2' },
				{ text: 'Hashtag 3', value: '3' },
				{ text: 'Hashtag 4', value: '4' },
				{ text: 'Hashtag 5', value: '5' },
				{ text: 'Hashtag 6', value: '6' },
				{ text: 'Hashtag 7', value: '7' },
				{ text: 'Hashtag 8', value: '8' },
				{ text: 'Hashtag 9', value: '9' },
				{ text: 'Hashtag 10', value: '10' },
			],
			quarter: "",
			quarterOption: [
