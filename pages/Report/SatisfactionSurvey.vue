				...
				<ScCard>
					...
					<ScCardBody>
						<div data-uk-grid="" class="uk-child-width-1-6@s uk-grid-small uk-grid">
							...
							<div>
								<ScInput v-model="form.surveyDate" v-flatpickr placeholder="Pick a date..." mode="outline">
						...
						<div data-uk-grid="" class="uk-child-width-expand@m uk-grid-small uk-grid">
							...
							<div>
								<select v-model="form.surveyResult" class="uk-select">
									<option v-for="option in surveyResultOption" v-bind:value="option.value">
										{{ option.text }}
									</option>
								</select>
							</div>
							...
							<div>
								<select v-model="form.noSurvey" class="uk-select">
									<option v-for="option in surveyOption" v-bind:value="option.value">
										{{ option.text }}
									</option>
								</select>
							</div>
...
<script>
	...
	export default {
		...
		data: () => ({
			...
			surveyOption: [
				{ text: 'All Survey', value: '' },
				{ text: 'No Survey', value: 'no' },
				{ text: 'survey', value: 'yes' },
			],
			surveyResultOption: [
				{ text: 'All Survey Result', value: '' },
				{ text: 'Very Good', value: '4' },
				{ text: 'Good', value: '3' },
				{ text: 'Medium', value: '2' },
				{ text: 'Poor/Improvement (1)', value: '1' },
				{ text: 'Complain', value: '' },
			...
			fields: [
				...
				{ key: 'customerName', label: 'Customer Name', sortable: true, class: 'text-left' },
				{ key: 'surveyResult', label: 'Survey Result', sortable: true, class: 'text-left' },
				{ key: 'noSurvey', label: 'No Survey', sortable: true, class: 'text-left' },
				{ key: 'agent', label: 'Agent', sortable: true, class: 'text-left' },
				{ key: 'surveyDate', label: 'Survey Date', sortable: true, class: 'text-left' },
			],
			pieChart: "",
			pieChartOption: [
				{ text: 'Survey Result', value: 'surveyResult' },
				{ text: 'Agent', value: 'agent' },
				{ text: 'Ticket Status', value: 'Customer Type' },
			],
			quarter: "",
			quarterOption: [
