				...
				<ScCard>
					...
					<ScCardBody>
						<div data-uk-grid="" class="uk-child-width-1-6@s uk-grid-small uk-grid">
							...
							<div>
								<ScInput v-model="form.assignDate" v-flatpickr placeholder="Pick a date..." mode="outline">
						...
						<div data-uk-grid="" class="uk-child-width-expand@m uk-grid-small uk-grid">
							...
							<div>
								<select v-model="form.firstTeam" class="uk-select">
									<option value="">All First Team</option>
							...
							<div>
								<select v-model="form.lastTeam" class="uk-select">
									<option value="">All Lastest Team</option>
									<option v-for="option in teamOption" v-bind:value="option.value">
										{{ option.text }}
									</option>
								</select>
...
<script>
	...
	export default {
		...
		data: () => ({
			...
			teamOption: [
				{ text: 'BD-CS', value: 'garage' },
				{ text: 'BD-Insurer', value: 'glass' },
				{ text: 'BD-Technical', value: 'part' },
				{ text: 'EPD', value: 'motorcycle' },
			],
			applicationOption: [
			...
			fields: [
				...
				{ key: 'team', label: 'First Team', sortable: true, class: 'text-left' },
				{ key: 'team', label: 'Last Team', sortable: true, class: 'text-left' },
				{ key: 'openDate', label: 'Open Date', sortable: true, class: 'text-left' },
				{ key: 'assign', label: 'Assign Date', sortable: true, class: 'text-left' },
